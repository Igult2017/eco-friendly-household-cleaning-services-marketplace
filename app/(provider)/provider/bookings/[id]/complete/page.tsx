  ...
  if (done) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center px-4">
        ...
        <h1 className="font-serif text-2xl font-bold text-[#2B3441] mb-2">Job Marked Complete!</h1>
  ...
  return (
    <div className="max-w-lg mx-auto py-6">
      ...
      <div className="flex gap-3">
        <Button variant="outline" onClick={() => router.back()} className="flex-1 h-11 border-[#E5EBF0]">Cancel</Button>
