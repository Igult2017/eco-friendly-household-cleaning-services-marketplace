-- Idempotent re-creation of referral tables.
-- 0011_referrals.sql was recorded in Drizzle's journal on production but never
-- actually applied (journal/DB mismatch). This migration fixes that safely.
...
-- dual_role_enabled added in 0012 — repeat here with IF NOT EXISTS in case
-- 0012 was also skipped by the same journal mismatch.
