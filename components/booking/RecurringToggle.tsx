  ...
  return (
    <div className="rounded-2xl border border-[#E5EBF0] bg-white p-4">
      ...
      <label className="flex items-center justify-between cursor-pointer gap-3">
        <div>
          <p className="text-sm font-semibold text-[#2B3441]">Make this recurring?</p>
          <p className="text-xs text-[#6B7280] mt-0.5">Automate regular cleaning sessions</p>
        </div>
        <button
          type="button"
          role="switch"
      ...
      {enabled && (
        <div className="mt-5 space-y-4 border-t border-[#E5EBF0] pt-5">
          {/* Frequency */}
          <div>
            <label className="block text-sm font-medium text-[#2B3441] mb-1.5">Frequency</label>
            <select
              value={frequency}
          ...
          {/* Day of week */}
          <div>
            <label className="block text-sm font-medium text-[#2B3441] mb-1.5">Day of week</label>
            <select
              value={dayOfWeek}
          ...
          {/* Preferred time */}
          <div>
            <label className="block text-sm font-medium text-[#2B3441] mb-1.5">Preferred time</label>
            <input
              type="time"
              value={preferredTime}
