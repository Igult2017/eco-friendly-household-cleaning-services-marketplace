// Product/brand context fed to the AI so generated emails reference REAL DORIXÉ
...
Services offered:
- Regular Cleaning (routine upkeep)
- Deep Cleaning (top-to-bottom)
- Move-in / Move-out
- Office Cleaning
- Laundry
- Window Cleaning
- Appliance Cleaning (oven, fridge, dishwasher, washing machine)

Trust signals: identity-verified cleaners, secure Stripe payments, money held until the job is done, 5-star support, GDPR-compliant.
`.trim()
