...
const NOTIF: Record<string, Record<string, S>> = {
  ...
  review_received: {
    en: { title: "New review received", body: "A client rated your work {rating}/5. Tap to see what they wrote." },
    de: { title: "Neue Bewertung erhalten", body: "Ein Kunde hat deine Arbeit mit {rating}/5 bewertet. Tippe, um zu sehen, was er geschrieben hat." },
    fr: { title: "Nouvel avis reçu", body: "Un client a noté votre travail {rating}/5. Appuyez pour voir son commentaire." },
    es: { title: "Nueva reseña recibida", body: "Un cliente valoró tu trabajo con {rating}/5. Toca para ver lo que escribió." },
    it: { title: "Nuova recensione ricevuta", body: "Un cliente ha valutato il tuo lavoro {rating}/5. Tocca per vedere cosa ha scritto." },
    nl: { title: "Nieuwe review ontvangen", body: "Een klant beoordeelde je werk met {rating}/5. Tik om te zien wat hij schreef." },
    pl: { title: "Otrzymano nową opinię", body: "Klient ocenił Twoją pracę na {rating}/5. Dotknij, aby zobaczyć, co napisał." },
    pt: { title: "Nova avaliação recebida", body: "Um cliente avaliou o seu trabalho com {rating}/5. Toque para ver o que escreveu." },
  },
  new_message: {
